...
let programs = [
  ...
  },
  {
    ...
    hostname: 'https://www.delta.com',
    icon: "http://images.delta.com/delta/misc/favicon.ico",
    pageMod: "delta.js",
    urls: {
      login: 'https://www.delta.com/skymiles/manage_account/view_account_activity/index.jsp',
      account: 'https://www.delta.com/skymiles/manage_account/view_account_activity/index.jsp',
    },
    links: [
      {
        title: 'reservations',
      ...
      {
        title: 'program',
        href: 'http://www.delta.com/skymiles/manage_account/index.jsp'
      },
      {
        title: 'flyertalk',
        href: 'http://www.flyertalk.com/forum/delta-skymiles-665/'
      }
    ]
  },
  {
    name: "Hilton HHonors",
    domain: 'https://secure3.hilton.com',
    hostname: 'https://secure3.hilton.com',
    icon: "https://secure3.hilton.com/skins/en_US/HH/img/favicon.ico",
    pageMod: "hilton.js",
    urls: {
      login: 'https://secure3.hilton.com/en/hh/customer/login/index.htm?url=/en/hh/customer/account/index.htm',
      account: 'https://secure3.hilton.com/en/hh/customer/account/index.htm',
      logout: 'https://secure3.hilton.com/en/hh/customer/login/logout.htm'
    },
    links: [
      {
        title: 'reservations',
      ...
      {
        title: 'program',
        href: 'http://hhonors3.hilton.com/en/index.html'
      },
      {
        title: 'flyertalk',
        href: 'http://www.flyertalk.com/forum/hilton-hhonors-417/'
      }
    ]
  },
  {
